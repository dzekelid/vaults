...
- name: Azure Key Vault API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/vaults/master/_listings/azure-key-vault/subscriptions-subscriptionid-resourcegroups-resourcegroupname-providers-microsoft-keyvault-vaults-vaultname-get.md
x-common:
