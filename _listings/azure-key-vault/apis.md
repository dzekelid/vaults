...
- name: Azure Key Vault API Vaults List
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/vaults/master/_listings/azure-key-vault/subscriptions-subscriptionid-resources-get-postman.md
x-common:
